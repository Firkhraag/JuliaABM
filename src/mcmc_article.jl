...
function main()
    ...
    # nMAE = 0.49584258079654336
    # Dur: 0.20883697716582963
    # Suscept: [3.232207505240898, 3.1997390611628327, 3.835228913701325, 4.69732988301189, 3.9812691361753845, 4.116499045542743, 4.63777442571659]
    # Temp: [0.8818500886019052, 0.9114769767520778, 0.05273221498389483, 0.136642743638686, 0.04763604727881924, 0.08352751227989078, 0.3664451540091344]
    # Immunity dur: [356.55453021983215, 310.4852329234472, 131.40535531122566, 101.21164801149243, 115.42432736304653, 139.55279339595782, 154.64454294817418]
    # Rand inf prob: [0.0013942153040463537, 0.0007545504894755132, 0.0003793519200982525, 9.190550055800402e-6]
    ...
    infected_data_0 = infected_data_0_all[2:53, 21:27]
    ...
    infected_data_3 = infected_data_3_all[2:53, 21:27]
    ...
    infected_data_7 = infected_data_7_all[2:53, 21:27]
    ...
    infected_data_15 = infected_data_15_all[2:53, 21:27]
    ...
    # println(incidence_arr_mean[3, 3, 3])
    # println(num_infected_age_groups_viruses[3, 3, 3])

...
function main()
    ...
    duration_parameter_default = 3.3695943816524907
    susceptibility_parameters_default = [3.0307005776255167, 3.1607934669677986, 3.4273238632802836, 4.3725990337370515, 3.67390987352247, 3.8281846882573243, 4.746937978511825]
    temperature_parameters_default = [-0.95, -0.8874797488598941, -0.05, -0.11936936936936937, -0.11488698235671589, -0.17735457724319717, -0.31083867585078234]
    immune_memory_susceptibility_levels_default = [0.9381002876402393, 0.95, 0.9278778778778778, 0.8938438438438437, 0.9185685685685685, 0.8678178178178176, 0.9288288288288288]  
    mean_immunity_durations_default = [346.6586428571901, 313.6876979491992, 143.00214714069438, 94.5655000618681, 113.27047767241473, 139.89128281137963, 161.06429368899117]    
    random_infection_probabilities_default = [0.0013770303094598375, 0.0007744184671858813, 0.00041302869187678077, 9.182178576371385e-6]

...
function plot_all()
    ...
    nMAE_arr_temp = zeros(Float64, num_particles)
    ...
    for i = 1:num_swarm_runs
        for j = 1:num_particles
            ...
            nMAE_arr_temp[j] = sum(abs.(temp - num_infected_age_groups_viruses)) / sum(num_infected_age_groups_viruses)

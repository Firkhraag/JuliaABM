...
# ╔═╡ 436f5bda-cb62-42fa-bf5d-9d6867a5f108
folder_name = "base"

# ╔═╡ f96f7e85-367b-4015-a99a-cb261aec1a20
begin
    contact_counts_matrix = readdlm(joinpath(@__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts.csv"), ',', Float64)
	contact_counts_matrix_holiday = readdlm(joinpath(@__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_holiday.csv"), ',', Float64)
...
begin
	...
	for activity_num = 3:7
        contact_counts_matrix = readdlm(joinpath(
            @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_$(activity_num).csv"), ',', Float64)
        if activity_num == 3
            contact_counts_matrix += readdlm(joinpath(
                @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_1.csv"), ',', Float64)
            contact_counts_matrix += readdlm(joinpath(
                @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_2.csv"), ',', Float64)
		elseif activity_num == 5
			# contact_counts_matrix += readdlm(joinpath(
   #              @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_6.csv"), ',', Float64)
        elseif activity_num == 7
            contact_counts_matrix += readdlm(joinpath(
                @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_8.csv"), ',', Float64)
			 contact_counts_matrix_holiday = readdlm(joinpath(
                @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_7_holiday.csv"), ',', Float64)
	# 		contact_counts_matrix_holiday += readdlm(joinpath(
 #                @__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_counts_activity_8_holiday.csv"), ',', Float64)
...
# ╔═╡ 79c45cd1-b830-47df-9f57-e95c0412a4c9
plot_arr[2]
...
begin
    contact_durations_matrix = readdlm(joinpath(@__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_durations.csv"), ',', Float64)
	contact_durations_matrix_holiday = readdlm(joinpath(@__DIR__, "..", "..", "..", "sensitivity", "heatmaps", folder_name, "contact_durations_holiday.csv"), ',', Float64)
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "211fba4692ce845518ee57f886b0ea0ba5bef32f"

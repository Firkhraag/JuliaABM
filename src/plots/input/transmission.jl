...
function plot_temperature_influence_year()
    ...
    temperature_parameters = [-0.8053782725211294, -0.8363327149041434, -0.17125252525252527, -0.07122626262626264, -0.23306431663574506, -0.2045104102246967, -0.2105050505050498]
    temp_influence(x, v) = temperature_parameters[v] * x + 1.0

...
const Home = () => {
    ...
    const [d, setD] = useState("0.1557")

    const [s1, setS1] = useState("2.4324")
    const [s2, setS2] = useState("2.2381")
    const [s3, setS3] = useState("3.9301")
    const [s4, setS4] = useState("5.172")
    const [s5, setS5] = useState("5.1447")
    const [s6, setS6] = useState("4.3416")
    const [s7, setS7] = useState("5.6261")

    const [t1, setT1] = useState("0.925")
    const [t2, setT2] = useState("0.724")
    const [t3, setT3] = useState("0.05")
    const [t4, setT4] = useState("0.106")
    const [t5, setT5] = useState("0.039")
    const [t6, setT6] = useState("0.037")
    const [t7, setT7] = useState("0.201")

    const [r1, setR1] = useState("156.0")
    const [r2, setR2] = useState("247.2")
    const [r3, setR3] = useState("147.9")
    const [r4, setR4] = useState("203.0")
    const [r5, setR5] = useState("79.8")
    const [r6, setR6] = useState("177.2")
    const [r7, setR7] = useState("99.2")

    const [p1, setP1] = useState("0.001")
    const [p2, setP2] = useState("0.0007")
    const [p3, setP3] = useState("0.00044")
    const [p4, setP4] = useState("0.0000087")

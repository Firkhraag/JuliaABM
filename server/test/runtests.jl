...
# !!! Main.UserApp is configured as an alias for Main.TestABM and you might encounter it in some tests
using Main.TestABM, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "TestABM tests" begin
  @includetests ARGS
end

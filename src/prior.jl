...
function main()
    ...
    # MAE = 797.8021867217886
    # RMSE = 1465.4338331615286
    # nMAE = 0.4594458401803152
    # S_square = 3.1267546410092583e9
    duration_parameter = 3.4779014636157473
    susceptibility_parameters = [3.2019789734075443, 3.3700061842918965, 3.553927025355601, 5.118449804164092, 3.997210884353748, 3.9103648732220133, 4.740830756545038]
    temperature_parameters = [-0.8084085755514324, -0.9221913007627294, -0.19650505050505052, -0.09950909090909092, -0.18962997320140162, -0.2216227581941868, -0.1777777777777777]
    random_infection_probabilities = [0.0001162529375386518, 6.789389816532672e-5, 4.928297258297261e-5, 7.142115027829316e-7]
    mean_immunity_durations = [255.51370851370848, 301.4654710368997, 96.63244691816121, 50.36837765409193, 90.93279736136878, 114.15192743764172, 107.06266749123895]

...
# Air temperature starting from January 1
function get_air_temperature(global_warming::Bool = false)::Vector{Float64}
    if global_warming
        return 2.0 .+ [-5.8, -5.9, -5.9, -5.9,

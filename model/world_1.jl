module Model
    ...
    function create_agent(
        ...
        districts = [[52,51,52,50,50,50,48,48,44,46,46,45,38,38,36,32,29,22,51,34,67,55,44,54,47,26,63,81,94],
        ...
        if is_child
            if parent_age < 23
                # M0–4
                return Agent(household, sex_random_num <= districts[index][1], rand(0:(parent_age - 18)))
            elseif parent_age < 28
                # T0-4_0–9
                if (age_rand_num <= districts[index][19])
                    # M0–4
                    Agent(household, sex_random_num <= districts[index][1], rand(0:4))
                else
                    # M5–9
                    Agent(household, sex_random_num <= districts[index][2], rand(5:(parent_age - 18)))
                end
            elseif parent_age < 33
                # T0-4_0–14
                if (age_rand_num <= districts[index][20])
                    # M0–4
                    Agent(household, sex_random_num <= districts[index][1], rand(0:4))
                # T0-9_0–14
                elseif (age_rand_num <= districts[index][21])
                    # M5–9
                    Agent(household, sex_random_num <= districts[index][2], rand(5:9))
                else
                    # M10–14
                    Agent(household, sex_random_num <= districts[index][3], rand(10:(parent_age - 18)))
                end
            elseif parent_age < 35
                ...
                if age_group_rand_num <= district_households[1][district_household_index]
                    ...
                    elseif (age_rand_num <= districts[index][21])
                        ...
                        # M10–14
                        Agent(household, sex_random_num <= districts[index][3], rand(10:14))
                    end
                else
                    # M15–19
                    return Agent(household, sex_random_num <= districts[index][4], rand(15:(parent_age - 18)))
                end
            else
                age_group_rand_num = rand(1:100)
                if age_group_rand_num <= district_households[1][district_household_index]
                    ...
                    # M15–19
                    return Agent(household, sex_random_num <= districts[index][4], rand(15:17))
                end
            end
        else
            age_group_rand_num = rand(1:100)
            ...
            if age_group_rand_num <= district_households[2][district_household_index]
                if is_male !== nothing
                    ...
                    # M20–24
                    return Agent(household, sex_random_num <= districts[index][5], rand(18:24))
                end
            elseif age_group_rand_num <= district_households[3][district_household_index]
                # T25-29_25–34
                if age_rand_num <= districts[index][22]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(25:29))
                    else
                        # M25–29
                        return Agent(household, sex_random_num <= districts[index][6], rand(25:29))
                    end
                else
                    if is_male !== nothing
                        ...
                        # M30–34
                        return Agent(household, sex_random_num <= districts[index][7], rand(30:34))
                    end
                end
            elseif age_group_rand_num <= district_households[4][district_household_index]
                # T35-39_35–44
                if age_rand_num <= districts[index][23]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(35:39))
                    else
                        # M35–39
                        return Agent(household, sex_random_num <= districts[index][8], rand(35:39))
                    end
                else
                    if is_male !== nothing
                        ...
                        # M40–44
                        return Agent(household, sex_random_num <= districts[index][9], rand(40:44))
                    end
                end
            elseif age_group_rand_num <= district_households[5][district_household_index]
                # T45-49_45–54
                if age_rand_num <= districts[index][24]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(45:49))
                    else
                        # M45–49
                        return Agent(household, sex_random_num <= districts[index][10], rand(45:49))
                    end
                else
                    if is_male !== nothing
                        ...
                        # M50–54
                        return Agent(household, sex_random_num <= districts[index][11], rand(50:54))
                    end
                end
            elseif age_group_rand_num <= district_households[6][district_household_index]
                # T55-59_55–64
                if age_rand_num <= districts[index][25]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(55:59))
                    else
                        # M55–59
                        return Agent(household, sex_random_num <= districts[index][12], rand(55:59))
                    end
                else
                    if is_male !== nothing
                        ...
                        # M60–64
                        return Agent(household, sex_random_num <= districts[index][13], rand(60:64))
                    end
                end
            else
                # T65-69_65–89
                if age_rand_num <= districts[index][26]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(65:69))
                    else
                        # M65–69
                        return Agent(household, sex_random_num <= districts[index][14], rand(65:69))
                    end
                # T65-74_65–89
                elseif age_rand_num <= districts[index][27]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(70:74))
                    else
                        # M70–74
                        return Agent(household, sex_random_num <= districts[index][15], rand(70:74))
                    end
                # T65-79_65–89
                elseif age_rand_num <= districts[index][28]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(75:79))
                    else
                        # M75–79
                        return Agent(household, sex_random_num <= districts[index][16], rand(75:79))
                    end
                # T65-84_65–89
                elseif age_rand_num <= districts[index][29]
                    if is_male !== nothing
                        return Agent(household, is_male, rand(80:84))
                    else
                        # M80–84
                        return Agent(household, sex_random_num <= districts[index][17], rand(80:84))
                    end
                else
                    if is_male !== nothing
                        ...
                        # M85–89
                        return Agent(household, sex_random_num <= districts[index][18], rand(85:89))
                    end
                end
            end
        end
    ...
    function create_parents_with_children(
        ...
        agent_male = create_agent(household, index, district_households, district_household_index, true)
        ...
        if num_of_other_people > 0
            agent_other = create_agent(household, index, district_households, district_household_index)
            if num_of_other_people > 1
                agent_other2 = create_agent(household, index, district_households, district_household_index)
                if num_of_other_people > 2
                    agent_other3 = create_agent(household, index, district_households, district_household_index)
                    if num_of_other_people > 3
                        agent_other4 = create_agent(household, index, district_households, district_household_index)
                    end
                end
            end
        end
        if num_of_children > 0
            child = create_agent(household, index, district_households, district_household_index, nothing, true, agent_female.age)
            ...
            child2 = create_agent(household, index, district_households, district_household_index, nothing, true, agent_female.age)
            ...
            child3 = create_agent(household, index, district_households, district_household_index, nothing, true, agent_female.age)
    ...
    function create_parent_with_children(
        ...
        parent = create_agent(household, index, district_households, district_household_index, is_male_parent, false, nothing, num_of_other_people > 0)
        agent_other::Union{Agent, Nothing} = nothing
        agent_other2::Union{Agent, Nothing} = nothing
        agent_other3::Union{Agent, Nothing} = nothing
        agent_other4::Union{Agent, Nothing} = nothing
        if num_of_other_people > 0
            if with_parent_of_parent
                agent_other = create_agent(household, index, district_households, district_household_index, nothing, false, parent.age, false, true)
            else
                agent_other = create_agent(household, index, district_households, district_household_index, nothing, false, parent.age)
            end
            if num_of_other_people > 1
                agent_other2 = create_agent(household, index, district_households, district_household_index, nothing, false, parent.age)
                if num_of_other_people > 2
                    agent_other3 = create_agent(household, index, district_households, district_household_index, nothing, false, parent.age)
                    if num_of_other_people > 3
                        agent_other4 = create_agent(household, index, district_households, district_household_index, nothing, false, parent.age)
                    end
                end
            end
        end
        if num_of_children > 0
            child = create_agent(household, index, district_households, district_household_index, nothing, true, parent.age)
            ...
            child2 = create_agent(household, index, district_households, district_household_index, nothing, true, parent.age)
            ...
            child3 = create_agent(household, index, district_households, district_household_index, nothing, true, parent.age)
    ...
    function create_others(
        ...
        agent = create_agent(household, index, district_households, district_household_index)
        agent_other::Union{Agent, Nothing} = nothing
        agent_other2::Union{Agent, Nothing} = nothing
        agent_other3::Union{Agent, Nothing} = nothing
        agent_other4::Union{Agent, Nothing} = nothing
        ...
        if num_of_children > 0
            child = create_agent(household, index, district_households, district_household_index, nothing, true, 35)
            ...
            child2 = create_agent(household, index, district_households, district_household_index, nothing, true, 35)
            ...
            child3 = create_agent(household, index, district_households, district_household_index, nothing, true, 35)
    ...
    function create_population()
        ...
        for index in district_nums
            ...
            for i in 1:districts[index][1]
                # 1P
                household = Group()
                agents = Agent[create_agent(household, index, district_households, index_for_1_people)]
            ...
            for i in 1:districts[index][2]
                # PWOP2P0C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_2_people, 0, 0, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][3]
                # PWOP3P0C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_3_people, 0, 1, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][4]
                # PWOP3P1C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_3_people, 1, 0, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][5]
                # PWOP4P0C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_4_people, 0, 2, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][6]
                # PWOP4P1C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_4_people, 1, 1, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][7]
                # PWOP4P2C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_4_people, 2, 0, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][8]
                # PWOP5P0C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 0, 3, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][9]
                # PWOP5P1C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 1, 2, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][10]
                # PWOP5P2C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 2, 1, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][11]
                # PWOP5P3C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 3, 0, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][12]
                # PWOP6P0C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 0, 4, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][13]
                # PWOP6P1C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 1, 3, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][14]
                # PWOP6P2C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 2, 2, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][15]
                # PWOP6P3C
                household = Group()
                agents = create_parents_with_children(household, district_households, index_for_5_people, 3, 1, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][16]
                # 2PWOP4P0C
                household = Group()
                pair1 = create_parents_with_children(household, district_households, index_for_4_people, 0, 0, index)
                pair2 = create_parents_with_children(household, district_households, index_for_4_people, 0, 0, index)
            ...
            for i in 1:districts[index][17]
                # 2PWOP5P0C
                household = Group()
                pair1 = create_parents_with_children(household, district_households, index_for_5_people, 0, 1, index)
                pair2 = create_parents_with_children(household, district_households, index_for_5_people, 0, 0, index)
                agents = vcat(pair1, pair2)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
            ...
            for i in 1:districts[index][18]
                # 2PWOP5P1C
                household = Group()
                pair1 = create_parents_with_children(household, district_households, index_for_5_people, 1, 0, index)
                pair2 = create_parents_with_children(household, district_households, index_for_5_people, 0, 0, index)
                agents = vcat(pair1, pair2)
                household.agents = agents
                add_agents_to_collectives(
            ...
            for i in 1:districts[index][19]
                ...
                household = Group()
                pair1 = create_parents_with_children(household, district_households, index_for_5_people, 0, 1, index)
                pair2 = create_parents_with_children(household, district_households, index_for_5_people, 0, 1, index)
                agents = vcat(pair1, pair2)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
            ...
            for i in 1:districts[index][21]
                ...
                household = Group()
                pair1 = create_parents_with_children(household, district_households, index_for_5_people, 1, 0, index)
                pair2 = create_parents_with_children(household, district_households, index_for_5_people, 1, 0, index)
                agents = vcat(pair1, pair2)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
            ...
            for i in 1:districts[index][22]
                # SMWC2P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_2_people, 0, 1, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][23]
                # SMWC2P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_2_people, 1, 0, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][24]
                # SMWC3P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 0, 2, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][25]
                # SMWC3P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 1, 1, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][26]
                # SMWC3P2C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 2, 0, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][27]
                # SMWC4P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 0, 3, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][28]
                # SMWC4P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 1, 2, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][29]
                # SMWC4P2C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 2, 1, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][30]
                # SMWC4P3C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 3, 0, index, false)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][31]
                # SFWC2P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_2_people, 0, 1, index, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][32]
                # SFWC2P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_2_people, 1, 0, index, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][33]
                # SFWC3P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 0, 2, index, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][34]
                # SFWC3P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 1, 1, index, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][35]
                # SFWC3P2C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 2, 0, index, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][36]
                # SPWCWP3P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 0, 2, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][37]
                # SPWCWP3P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_3_people, 1, 1, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][38]
                # SPWCWP4P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 0, 3, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][39]
                # SPWCWP4P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 1, 2, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][40]
                # SPWCWP4P2C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_4_people, 2, 1, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][46]
                # SPWCWPWOP5P0C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_5_people, 0, 4, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][47]
                # SPWCWPWOP5P1C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_5_people, 1, 3, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][48]
                # SPWCWPWOP5P2C
                household = Group()
                agents = create_parent_with_children(household, district_households, index_for_5_people, 2, 2, index, nothing, true)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][49]
                # O2P0C
                household = Group()
                agents = create_others(household, district_households, index_for_2_people, 0, 2, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][50]
                # O2P1C
                household = Group()
                agents = create_others(household, district_households, index_for_2_people, 1, 1, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][51]
                # O3P0C
                household = Group()
                agents = create_others(household, district_households, index_for_3_people, 0, 3, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][52]
                # O3P1C
                household = Group()
                agents = create_others(household, district_households, index_for_3_people, 1, 2, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][53]
                # O3P2C
                household = Group()
                agents = create_others(household, district_households, index_for_3_people, 2, 1, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][54]
                # O4P0C
                household = Group()
                agents = create_others(household, district_households, index_for_4_people, 0, 4, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][55]
                # O4P1C
                household = Group()
                agents = create_others(household, district_households, index_for_4_people, 1, 3, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][56]
                # O4P2C
                household = Group()
                agents = create_others(household, district_households, index_for_4_people, 2, 2, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][57]
                # O5P0C
                household = Group()
                agents = create_others(household, district_households, index_for_5_people, 0, 5, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][58]
                # O5P1C
                household = Group()
                agents = create_others(household, district_households, index_for_5_people, 1, 4, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
            ...
            for i in 1:districts[index][59]
                # O5P2C
                household = Group()
                agents = create_others(household, district_households, index_for_5_people, 2, 3, index)
                household.agents = agents
                add_agents_to_collectives(
                    agents, kindergarten, kindergarten_group_sizes,
                    school, school_group_sizes,
